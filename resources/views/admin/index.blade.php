...
<section>
		...
		<ul>
            <li>
                ...
                <ul class="sub_menu">
                    ...
                    <li><a href="{{url('article')}}" target="main"><i class="fa fa-fw fa-list-alt"></i>文章列表</a></li>
                    <li><a href=" " target="main"><i class="fa fa-fw fa-image"></i>图片列表</a></li>
                </ul>
            </li>
            <li>
	...
	<div class="bottom_box">
		CopyRight © 2015. Powered By <a href="http://togethergo.me">http://togethergo.me</a>.
	</div>
	<!--底部 结束-->
</body>
</html>
