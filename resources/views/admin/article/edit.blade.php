...
<div class="result_wrap">
    <form action="{{url('article/'.$arti->art_id)}}" method="post">
      <input type="hidden" name="_method" value="put">
        ...
        <table class="add_tab">
            ...
            <tr>
                ...
                <td>
                    <input type="text" class="lg" name="art_title" value="{{@$arti->art_title}}">
                </td>
            </tr>
            <tr>
                <th>编辑：</th>
                <td>
                    <input type="text" class="sm" name="art_auther" value="{{@$arti->art_auther}}">
                </td>
            </tr>
            ...
            <tr>
                <th>关键词：</th>
                <td>
                    <input type="text" class="lg" name="art_tag" value="{{@$arti->art_tag}}">
                </td>
            </tr>
            <tr>
                <th>描述：</th>
                <td>
                    <textarea name="art_descript">{{@$arti->art_descript}}</textarea>
                </td>
            </tr>
                ...
                <td>
                    ...
                    <script type="text/javascript">
                        ...
                        ue.ready(function() {//编辑器初始化完成再赋值
                          ue.setContent('<?php echo @$arti->art_content; ?>');});//赋值给UEditor
                    </script>
                    <style>
